 ...
 * @author tusee
 */
public class deleteManagerGUI extends JFrame 
{
    ...
    {
        deleteManagerGUI a = new deleteManagerGUI();
    ...
    public deleteManagerGUI()
    {
        ...
        title = new JLabel("Delete Manager:");
        title.setFont(f1);
    ...
    public class addManagerListener implements ActionListener
    {
        ...
        {   
            ...
            if(e.getActionCommand().equals("Search"))
            {
                ...
                if(!check1)
                {
                    ...
                    for(int j = 0; j<adminList.size(); j++)
                    {
                        ...
                        {
                            t2.setText(adminList.get(j).getName()); //name
            ...
            else if(e.getActionCommand().equals("Delete"))
            {
                try
                {
                    adminList.remove(adminList.get(check));

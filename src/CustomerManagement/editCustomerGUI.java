...
public class editCustomerGUI extends JFrame
{
    ...
    {
        editCustomerGUI a = new editCustomerGUI();
    ...
    public void diposeeditCustomerFrame()
    {
        this.dispose();
    }
            ...
            else if(e.getActionCommand().equals("Update"))
            {
                ...
                try
                {
                        ...
                        || (t5.getText().isEmpty()) || (t6.getText().isEmpty()) || (t7.getText().isEmpty())))
                    {
                        ...
                        //String name, String phone, String cnic, String industryName, Address address, int customerID
                        Address address = new Address(a6, a7);
                        Customer update = new Customer(a2, a3, a4, a5, address, a1);
                    
                        customerList.add(check, update);
                        ...
                        JOptionPane.showMessageDialog(null, "Customer's data updated successfully.");
                        t1.setEditable(true);

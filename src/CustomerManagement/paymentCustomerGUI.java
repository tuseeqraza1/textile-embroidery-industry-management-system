 ...
 * @author tusee
 */
class paymentCustomerGUI extends JFrame
{
        ...
        {   
            ...
            {   
                        ...
                        || (t4.getText().isEmpty()) || (t5.getText().isEmpty())))
                {
                    ...
                    try
                    {
                        customerList.get(check).setPayment(r);
            ...
            {
                diposepaymentCustomerFrame();
                CustomerMainGUI cg = new CustomerMainGUI();
            }
        }
    }
    public void diposepaymentCustomerFrame()
    {
        this.dispose();
    }
}

 ...
 * @author tusee
 */
class deleteSellerGUI extends JFrame
{
    ...
    public deleteSellerGUI()
    {
        ...
        title = new JLabel("Delete Seller:");
        title.setFont(f1);
        ...
        deletesellerListener a1 = new deletesellerListener();
    ...
    public void diposedeleteSellerFrame()
    {
        this.dispose();
    }
    
    public class deletesellerListener implements ActionListener
    {
        @Override
        ...
        {   
            ...
            else if(e.getActionCommand().equals("Delete"))
            {
                ...
                try
                {
                    sellerList.remove(sellerList.get(check));
                    ...
                    JOptionPane.showMessageDialog(null, "Seller's data deleted successfully.");

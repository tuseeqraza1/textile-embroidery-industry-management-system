...
public class billSellerGUI extends JFrame
{
    ...
    public billSellerGUI()
    {
        ...
        ArrayList<Bill> billsList = ReadData.readSellerBills();
        ...
        b1 = new JButton("Add");
        b1.setBounds(235, 590, 150, 30);
        b2 = new JButton("Clear");
        b2.setBounds(425, 590, 150, 30);
        b3 = new JButton("Back");
        b3.setBounds(615, 590, 150, 30);
        ...
        billSellerListener a1 = new billSellerListener();
    ...
    public void diposebillSellerFrame()
    {
        this.dispose();
    }
    
    public class billSellerListener implements ActionListener
    {
        @Override
        ...
        {   
            ...
            else if(e.getActionCommand().equals("Calculate"))
            {
                if(!(t6.getText().isEmpty() || t7.getText().isEmpty()))
                {
                    ...
                    try
                    {
                        ...
                        t = rawList.get(check2).getPrice() * q;
            ...
            {   
                        ...
                        (t8.getText().isEmpty()) || (t9.getText().isEmpty())))
                {
                    ...
                    Product product = rawList.get(check2); // store product selected
                    int quantity = 0;
                    ...
                    if(!check1)
                    {
                        ...
                        try
                        {
                            sellerList.get(check).setBills(bill1);
                            billsList.add(bill1);

                            output = new ObjectOutputStream(new FileOutputStream("src/files/Seller.ser"));
                            output1 = new ObjectOutputStream(new FileOutputStream("src/files/SellerBills.ser"));
